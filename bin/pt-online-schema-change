...
name change metadata version in the table cache will also change and you may start receiving 
"Prepared statement needs to be re-prepared" errors. Workaround for this is to re-prepare statements. 
If you do not use server-side prepared statements your application would not be affected.
