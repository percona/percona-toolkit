...
Note that this requires Percona XtraDB Cluster 5.5.27-23.6 or newer, as the fix depends on this bug [https://bugs.launchpad.net/codership-mysql/+bug/1023911](https://bugs.launchpad.net/codership-mysql/+bug/1023911) being resolved.
...
pt-table-checksum used to check the user’s privileges, but the method was not always reliable, and due to [http://bugs.mysql.com/bug.php?id=61846](http://bugs.mysql.com/bug.php?id=61846) it became quite unreliable on MySQL 5.5.  So the privs check was removed altogether, meaning that the tool may fail later if the user’s privileges are insufficient.
...
[http://www.percona.com/software/percona-toolkit/](http://www.percona.com/software/percona-toolkit/)
or the Percona Software Repositories
([http://www.percona.com/docs/wiki/repositories:start](http://www.percona.com/docs/wiki/repositories:start)).
...
* Fixed bug 857091: pt-sift downloads [http://percona.com/get/pt-pmp](http://percona.com/get/pt-pmp), which does not work
...
Percona Toolkit packages can be downloaded from
[http://www.percona.com/downloads/percona-toolkit/](http://www.percona.com/downloads/percona-toolkit/)
or the Percona Software Repositories
([http://www.percona.com/docs/wiki/repositories:start](http://www.percona.com/docs/wiki/repositories:start)).

Although Maatkit and Aspersa development use Google Code, Percona Toolkit
uses Launchpad: [https://launchpad.net/percona-toolkit](https://launchpad.net/percona-toolkit)

[1] [http://www.xaprb.com/blog/2011/07/06/planned-change-in-maatkit-aspersa-development/](http://www.xaprb.com/blog/2011/07/06/planned-change-in-maatkit-aspersa-development/)
